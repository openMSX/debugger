	...
	: QDialog(parent)
{
	...
	connect( listFonts, SIGNAL( currentRowChanged( int ) ), this, SLOT( fontSelectionChange( int ) ) );
	connect( rbUseAppFont, SIGNAL( toggled(bool) ), this, SLOT( fontTypeChanged(bool) ) );
	connect( rbUseFixedFont, SIGNAL( toggled(bool) ), this, SLOT( fontTypeChanged(bool) ) );
	connect( rbUseCustomFont, SIGNAL( toggled(bool) ), this, SLOT( fontTypeChanged(bool) ) );
	connect( btnSelectFont, SIGNAL( clicked() ), this, SLOT( fontSelectCustom() ) );
	connect( btnFontColor, SIGNAL( clicked() ), this, SLOT( fontSelectColor() ) );
