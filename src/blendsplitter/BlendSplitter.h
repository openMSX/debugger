#ifndef BLENDSPLITTER_H
#define BLENDSPLITTER_H
...
public:
    static constexpr int expanderSize = 12; /**< Size of the expanders in the corners. Default value: 12 */
    static constexpr int switchingBarHeight = 32; /**< Height of the SwitchingBar. Default value: 36 */
    static constexpr const char* const expanderImage = ":/BlendSplitter/Expander"; /**< The image to be used for the top left expander. The bottom right one will rotate this by pi (180 degrees). Default value: \":/BlendSplitter/Expander\" */

public:
    BlendSplitter(const BlendSplitter&) = delete;
    BlendSplitter& operator=(const BlendSplitter&) = delete;
...
private:
    ...
    std::function<QWidget*()> defaultWidget;
